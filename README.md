...
- The gateway uses TCP transport for microservice communication
- All endpoints are prefixed with `/api`
- Global validation pipe is configured with whitelist and strict mode
- Custom RPC exception filter handles microservice errors
- Environment variables are validated using Joi schemas